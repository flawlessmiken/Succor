...
import com.flawlessconcepts.succor.adapters.Converters
 ...
 * so you can reuse it.
 */
@Database(entities = [QuestionObj::class], version = 4, exportSchema = false)
...
abstract class QuestionsDatabase : RoomDatabase() {
     ...
     */
    abstract val questionsDbDao: QuestionsDbDao
